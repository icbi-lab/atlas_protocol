...
#  * Very recently, [LIANA+](https://liana-py.readthedocs.io/en/latest/index.html) {cite}`dimitrovLIANAAllinoneCellcell2023` and [MultiNicheNet](https://github.com/saeyslab/multinichenetr) {cite}`browaeysMultiNicheNetFlexibleFramework2023`
#    became available. Both are extensions to the original Liana and NicheNet packages that explicitly address differential cell2cell communication between conditions.
# :::
